// Generated by Copilot: fix strict TS implicit any errors in palette gradient computation
...
export class AppComponent implements OnInit {
  ...
  sidebarAvatarGradient = computed(() => {
    ...
    // Explicitly type callback params to satisfy strict/noImplicitAny
    const stops = palette
      .slice(0, 3)
      .map((color: string, index: number, arr: string[]) => {
